...
export default function HoneymoonSuiteWhale() {
    const { auth } = usePage<SharedData>().props;

    const amenities = [
        { icon: Bed, text: '1 King sized bed' },
        { icon: Users, text: 'Living room area with sofa set' },
        { icon: Users, text: 'Private balcony' },
        { icon: Bath, text: 'Large bathroom with bathtub' },
    ...
    const similarRooms = [
        {
            ...
            link: '/suite'  // ✅ Matches Route::get('suite', ...)
        },
        {
    ...
    return (
        <>
            <Head title="Honeymoon Suite Whale | Pura Vida Beach & Dive Resort">
            ...
            <div className="relative h-96 overflow-hidden">
                <img
                    src="/img/rooms/honeymoon.jpg"
                    alt="Honeymoon Suite Whale at Pura Vida"
                    className="w-full h-full object-cover"
                />
                <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center">
                    <div className="text-center text-white">
                        <h1 className="text-5xl font-bold mb-2">Honeymoon Suite Whale</h1>
                    </div>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 py-12">
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-12">
                    <div>
                        ...
                        <h2 className="text-3xl font-bold mb-4">Honeymoon Suite Whale</h2>
                        <p className="text-gray-700 mb-4 leading-relaxed">
                            Located on the 2nd floor above the equipment room of our dive center, the Honeymoon Suite Whale offers a private retreat with a balcony showcasing a scenic view of the sea, perfect for relaxation.
                        </p>
                        <p className="text-gray-700 mb-4 leading-relaxed">
                            The suite features a king-size bed, a flat-screen TV, and split-type air-conditioning to ensure a comfortable stay. The spacious bathroom includes a bathtub, hot and cold shower, and a double sink, ideal for indulgent moments.
                        </p>
                        <p className="text-gray-700 leading-relaxed">
                            Perfect for honeymooners, couples, or single travelers seeking a luxurious and pampering experience.
                        </p>
                    </div>
                    <div>
                        <img
                            src="/img/rooms/honeymoon.jpg"
                            alt="Honeymoon Suite Whale Interior"
                ...
                <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white rounded-lg p-8 mb-12">
                    <div className="grid md:grid-cols-2 gap-6 text-center">
                        <div>
                            ...
                            <p className="text-3xl font-bold">PHP 14,000</p>
                            <p className="text-sm">per night</p>
                        </div>
                        <div>
                            <p className="text-sm uppercase tracking-wide mb-2">Extra Mattress/Bed</p>
